...
export const SEED_EVENTS: SentraEvent[] = [
  ...
  // Older events so the Today / 7 days / 30 days tabs segment meaningfully.
  {
    ...
    rule_version: "1.0.0",
    policy_hash: "b3ad16c078d02959",
    inputs_sha256: "2e9f4a7c8b1d6053",
  },
  {
    timestamp: "2026-05-23 09:15:44",
    agent_id: "healthcare-agent-svc-002",
    action_type: "PRESCRIBE_MEDICATION",
    action_label: "Prescribe 5mg Warfarin daily",
    drug: "warfarin",
    dose: "5mg",
    frequency: "daily",
    ...
    rule_version: "1.0.0",
    policy_hash: "b3ad16c078d02959",
    inputs_sha256: "5b2c9e1f3a7d4806",
  },
  {
    timestamp: "2026-05-17 16:48:09",
    agent_id: "maf-clinical-pilot-003",
    action_type: "PRESCRIBE_MEDICATION",
    action_label: "Prescribe 5mg Methotrexate daily",
    drug: "methotrexate",
    dose: "5mg",
    frequency: "daily",
    patient_id: "P-2026-002",
    policy_triggered: "BLOCK_METHOTREXATE_FREQUENCY_MISMATCH",
    policy_description: "Methotrexate prescribed at daily frequency. Correct schedule is weekly.",
    threat_type: "Medication Dosing Error",
    risk: 0,
    attempted_risk: 80,
    projected_risk: 80,
    cumulative_risk: "0/100",
    decision: "Blocked",
    reason: "Methotrexate at daily frequency is contraindicated. Correct schedule is weekly.",
    event_trace: [
      "Tool invoked: PRESCRIBE_MEDICATION",
      "Drug: methotrexate",
      "Policy matched: BLOCK_METHOTREXATE_FREQUENCY_MISMATCH",
    ...
    rule_version: "1.0.0",
    policy_hash: "b3ad16c078d02959",
    inputs_sha256: "8d4e2c1a9f5b6037",
    citation:
      "ECRI 2025-2026 Top 10 Health Tech Hazards; EU AI Act Article 14(4)(d).",
  },
];
